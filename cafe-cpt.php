...
include_once plugin_dir_path( __FILE__ ) . 'cafe_cpt_updater.php';
...
if ( ! class_exists( 'Cafe_CPT' ) ) {
	final class Cafe_CPT {
		...
		private function __construct() {
			...
			/* Load updater */
			add_action( 'plugins_loaded', array( $this, 'init_updater' ), 4 );
		}
		...
		public function init_updater() {
			$updater = new Cafe_CPT_Updater( __FILE__ );
			$updater->set_username( 'josandreu' );
			$updater->set_repository( 'cafe-cpt-plugin' );
			//$updater->authorize( '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' );
			$updater->initialize();
		}
